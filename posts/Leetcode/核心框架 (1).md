...
删除过程如下：  
![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754613453-cb93ccc3-43f0-4c67-9e83-bf47e0992d40.gif)
...
算法执行的过程如下 GIF 图：  
![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754613565-9b8d4794-38c6-41b9-b258-df536bb483f5.gif)

###### 83.「 [删除排序链表中的重复元素](https://leetcode.cn/problems/remove-duplicates-from-sorted-list/)」
> 给定一个已排序的链表的头 head ， _删除所有重复的元素，使每个元素只出现一次_ 。返回 _已排序的链表_ 。  
**示例 1：**  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754613634-b551fcef-fde0-40f7-b5cb-9e3718182a41.jpeg)  
输入：head = [1,1,2]  
输出：[1,2]
>
...
算法执行的过程请看下面这个 GIF：  
![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754613698-72f35f3f-ed8a-43cb-b617-95bcd2e99d35.gif)
...
![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754613786-ff48a2fe-a112-467a-afb5-d15d83b3f4c0.gif)
...
> 给定两个长度相等的数组 `nums1` 和 `nums2`，`nums1` 相对于 `nums2` 的_优势_可以用满足 `nums1[i] > nums2[i]` 的索引 `i` 的数目来描述。
>
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754613900-eb6ce516-bc4c-4775-8e23-0b64f09f56fc.png)
...
>
> **示例 1：**  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754613979-c02d1a3a-03dd-4c22-805e-4837b908a822.jpeg)  
...
我们的 while 循环每次比较 p1 和 p2 的大小，把较小的节点接到结果链表上，看如下 GIF：![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754614072-857f5e29-7b3c-4f66-9862-145afdea4e3a.gif)  
...
>
> **示例 1：**  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754614140-e7772bb2-1a5d-4d95-b3f8-ee86d43f3ec8.jpeg)  
...
>
> **示例 1：**  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754614210-53fdea90-dca6-4fc4-902f-807ec8ecf51f.jpeg)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754614308-f38ed3f7-ebe7-4187-9da8-116a46ce15ba.png)

现在的 p1，只要再走 n - k 步，就能走到链表末尾的空指针了对吧？

趁这个时候，再用一个指针 p2 指向链表头节点 head：

![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754614368-01c9a706-59db-47f9-9745-4cb2a04dd836.png)

接下来就很显然了，让 p1 和 p2 同时向前走，p1 走到链表末尾的空指针时前进了 n - k 步，p2 也从 head 开始前进了 n - k 步，停留在第 n - k + 1 个节点上，即恰好停链表的倒数第 k 个节点上：

![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754614443-aec5e163-13ef-4a6a-a869-0d3451fd6e5c.png)
...
> **示例 1：**
>
> ![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754614514-e78dd523-2043-48a0-940e-6e61ec5e2927.png)
>
> 输入：[1,2,3,4,5]  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754614581-86c45c68-252c-4e13-9666-f91ea376fe4c.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754614654-596e9c0f-fe57-4e88-936c-afb1c28cba5d.png)
...
> **示例 1：**
>
> ![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754614732-069e5975-fb6d-437e-9b77-3d78c4df2dcc.png)
>
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754614798-0b9233d5-c197-46a2-bdd7-d09fbf61fd35.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754614858-9676ab25-6d70-4b24-b1d9-ac13c0621b1b.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615000-f1450cf4-2859-4b87-aefd-36563fe16301.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615080-f9c39620-5c5f-47fe-89e7-95157b1d97df.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615168-cf6790c1-57ac-4abd-a156-a4cc74d1943e.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615260-e356167b-9237-460d-9c6e-12b49960c058.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615376-0aa67960-7d0e-4bee-a57a-17974ee10e47.png)
...
> **示例 1：**
>
> ![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615471-9b663897-0520-447e-bddf-75bd43541b04.png)
>
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615541-9180d913-c87d-4542-9a1e-7af9f36ca3fc.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615629-98c99ceb-3ced-4bb8-aaea-41c77fb672ae.png)

实际上，带「备忘录」的递归算法，把一棵存在巨量冗余的递归树通过「剪枝」，改造成了一幅不存在冗余的递归图，极大减少了子问题（即递归图中节点）的个数。

![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615719-41913da8-504f-40a3-934b-15a7e6c7b868.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615800-8455db3e-51f6-4d85-8af6-789aed69e73e.png)  
画个图就很好理解了，而且你发现这个 DP table 特别像之前那个「剪枝」后的结果，只是反过来算而已。实际上，带备忘录的递归解法中的「备忘录」，最终完成后就是这个 DP table，所以说这两种解法其实是差不多的，大部分情况下，效率也基本相同。

这里，引出「状态转移方程」这个名词，实际上就是描述问题结构的数学形式：  
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615893-6c252111-c118-4de6-b6ad-aea86930e9d7.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754615971-86b1fde6-89f9-4f13-ad24-1ef262d08fa3.png)  
至此，这个问题其实就解决了，只不过需要消除一下重叠子问题，比如 amount = 11, coins = {1,2,5} 时画出递归树看看：

![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616060-e0b36a8e-17b7-4419-b0d8-14f9aacc0767.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616192-45b03b41-d126-4fba-8c79-8164ab2a2480.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616262-2708b738-1082-4f17-b567-547b37925bc5.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616325-d76d9717-9ffe-4086-92e8-154b9da83b9f.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616381-0cbbf179-b193-4a1e-9934-4705b6db86f1.png)  
因此，可用动态规划解决此问题，以上公式便为转移方程。

![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616438-1a66317a-5c2e-4025-9379-b45b1a8bf9b2.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616499-f109ed20-ff1e-4f6f-bb8b-46e3297bf3b3.png)
...
设已知长度为 _n_ 的丑数序列![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616562-95e0de3d-2b0e-4874-9d17-1b40fd1e3ffb.png)，求第 n+1 个丑数 ![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616627-ac240017-c762-41c9-9178-4714183d4bc9.png)。根根据递推性质，丑数 ![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616702-902cae65-834f-4992-8d4e-f54ce32935d2.png)只可能是以下三种情况其中之一（索引 a,b,c 为未知数）：  
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616762-22720589-ad7f-409a-9066-c65847c9eab5.png)  
**丑数递推公式：**  若索引 a,b,c 满足以上条件，则下个丑数 ![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616830-d317c9f9-6365-4afe-a3ba-c2cf66e3af8f.png)为以下三种情况中的 **最小值** ；  
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616885-b466f08c-ce61-4da9-a422-f461126bc6b0.png)  
由于![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754616953-dda80407-b2e2-40b2-857b-d8961a5f63ae.png)是 **最接近**![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754617129-7e7e01e0-a339-44d7-8de9-f59bb83e6cd2.png)的丑数，因此索引 a,b,c 需满足以下条件：  
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754617201-2378fde6-5c40-437b-9234-6711ae19aad9.png)  
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754617274-df52bc55-3cdd-4adc-971e-6b6806e48c73.png)  
因此，可设置指针 a,b,c 指向首个丑数（即 1 )，循环根据递推公式得到下个丑数，并每轮将对应指针执行 +1 即可。

> 假设当前存在 3 个数组 nums2, nums3, nums5 分别代表丑数序列从 1 开始分别乘以 2, 3, 5 的序列， 即
>
> nums2 = {1_2, 2_2, 3_2, 4_2, 5_2, 6_2, 8_2...} nums3 = {1_3, 2_3, 3_3, 4_3, 5_3, 6_3, 8_3...}
>
> nums5 = {1_5, 2_5, 3_5, 4_5, 5_5, 6_5, 8*5...}
>
> # 注意 7 不是丑数.
>
> # 2, 3, 5 这前 3 个丑数一定要乘以其它的丑数， 所得的结果才是新的丑数， 所以上例中没有出现 7_2, 7_3, 7*
>

**合并过程中重复解的处理**

nums2, nums3, nums5 中是存在重复的解的， 例如 nums2[2] == 3_2, nums3[1] == 2_3 都计算出了 6 这个结果， 所以在合并 3 个有序数组的过程中， 还需要跳过相同的结果， 这也就是为什么在比较的时候， 需要使用 3 个并列的 if... if... if... 而不是 if... else if... else 这种结构的原因。 当比较到元素 6 时， if (dp[i] == dp[p2] * 2)...if (dp[i] == dp[p3] * 3)... 可以同时指向 nums2, nums3 中 元素 6 的下一个元素。

**动态规划解析：**

+ **状态定义：**  设动态规划列表 _dp_ ，`dp[i]` 代表第 `i+1` 个丑数；
+ **转移方程：**
    1. 当索引 a,b,c 满足以下条件时，`dp[i]` 为三种情况的最小值；
    2. 每轮计算 `dp[i]` 后，需要更新索引 a,b,c 的值，使其始终满足方程条件。实现方法：分别独立判断 dp[i] 和 dp[a]×2, dp[b]×3, dp[c]×5 的大小关系，若相等则将对应索引 a , _b_ , _c_ 加 1 ；

![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754617340-07327418-df45-4c79-9a65-413e732cbacd.png)

+ **初始状态：**  `dp[0]`=1 ，即第一个丑数为 1 ；
+ **返回值：**  `dp[n-1]` ，即返回第 _n_ 个丑数；

![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754617401-7c84d3bc-9cf7-4008-9b14-d9810ec25a33.gif)
...
题目需要我们求出所有点数出现的概率，根据概率的计算公式，点数 _k_ 出现概率就算公式为：![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754617475-41c44630-d14c-4ad5-80ec-1c6205e73c05.png)  
投掷 n 个骰子，所有点数出现的总次数是 ![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754617578-435e1d30-3724-410f-a50a-2e8bcd15c60f.png) ,因为一共有 n 枚骰子，每枚骰子的点数都有 6 种可能出现的情况。
...
>
> ![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754617672-3065c129-9c7b-4f0e-b4e4-204901d3eb51.jpeg)
>
> 输入：n = 4  
输出：[[".Q..","...Q","Q...","..Q."],["..Q.","Q...","...Q",".Q.."]]
>
...
**为了判断一个位置所在的列和两条斜线上是否已经有皇后，使用三个集合**  _**col**_ _、__****__left_** **_**、**__****__**right**_ 分别记录每一列以及两个方向的每条斜线上是否有皇后。
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754617742-7ba2458c-cd4c-4dc7-8c79-e46158162597.png)

+ 左对角线为从右上到左下方向，同一条斜线上的每个位置满足行下标与列下标之和相等，即 `_row + j_`。例如 (3,0) 和 (1,2) 在同一条方向二的斜线上。因此使用行下标与列下标之和即可明确表示每一条左对角线的斜线。

![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754617815-aaeca3a0-b433-487e-b55c-2bea3e349d06.png)
...
> **示例 1：**
>
> ![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754617880-b827c23a-ca94-4f4b-a9ef-6e72b1b359b9.png)
>
> 输入：n = 4  
输出：2  
解释：如上图所示，4 皇后问题存在两个不同的解法。
...
>
> ![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754617954-e5f42e06-b539-452e-b3b2-c6fd383ce255.jpeg)
>
> **示例 1：**  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754618043-0442f1b9-1c4d-4a23-8c0b-c8c5bd567b08.png)
...
> 请实现一个函数用来匹配包含'. '和' _'的正则表达式。模式中的字符'.'表示任意一个字符，而'_ '表示它前面的字符可以出现任意次（含 0 次）。在本题中，匹配是指字符串的所有字符匹配整个模式。例如，字符串"aaa"与模式"a.a"和"ab_ac_a"匹配，但与"aa.a"和"ab_a&quot;均不匹配。输入: s = &quot;aa&quot; p = &quot;a_"
>
> 输出: true
>
...
1.1 p[j] 有可能会匹配多个字符，比如 s = "aaa", p = "a _&quot;，那么 p[0] 会通过 * 匹配 3 个字符 &quot;a&quot;。1.2 p[i] 也有可能匹配 0 个字符，比如 s = &quot;aa&quot;, p = &quot;a_aa"，由于后面的字符可以匹配 s，所以 p[0] 只能匹配 0 次。
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754618105-35749f45-74ef-4669-b2f2-96195a1aa356.png)

将 i 加 1，j 不变，含义就是 p[j] 匹配了 s[i]，但 p[j] 还可以继续匹配，即通配符匹配多次的情况：

![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754618185-be8c7c0a-27e5-43ed-a886-a6e3ce067d7e.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754618258-e7ca9ad6-097b-40ec-afa5-5d7423ce884a.png)

2.1 通配符匹配 0 次

类似情况 1.1，将 j 加 2，i 不变：

![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754618333-dd7f2fe0-f4a0-4b72-821e-875e068a59df.png)

2.2 如果没有 * 通配符，也无法匹配，那只能说明匹配失败了：

![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754618405-9f576ec4-f604-4cf6-a841-bdd37b563135.png)
...
**这是不正确的，此时并不能根据 j 是否等于 p.size() 来判断是否完成匹配，只要 p[j..] 能够匹配空串，就可以算完成匹配**。比如说 s = "a", p = "ab_c_"，当 i 走到 s 末尾的时候，j 并没有走到 p 的末尾，但是 p 依然可以匹配 s。
...
>
> **示例 1：**  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754618478-b6d5f5f8-0799-4123-98b1-fa8be498672d.jpeg)  
...
>
> **示例 1：**  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754618559-dcbaddea-b5ce-42cb-816c-f5b3c87b0994.jpeg)  
输入：root = [3,9,20,null,null,15,7]  
输出：2
>
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754618636-8cf693f9-8695-4309-91e8-8dba197f1ccf.png)
...
> **示例 1：**
>
> ![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754618714-a9cd9f16-69ff-473e-b4b6-2a51a3e52162.png)
>
...
![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754618780-6714e367-6cd9-464d-8c68-05d3df446314.gif)
...
![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754618869-6823864f-1ef3-4b94-a60a-40c099f05bd0.gif)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754619020-236bfe95-12a3-4625-b4af-301561e6cf4f.png)  
...
初始状态：  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754619079-4c2571f0-de91-4157-a1da-7bc3440dd365.jpeg)  
增加 right，直到窗口 [left, right) 包含了 T 中所有字符：  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754619147-a97ac697-0f08-460a-9b39-54e2d9631d47.jpeg)  
现在开始增加 left，缩小窗口 [left, right)：  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754619263-3c026447-57d7-4d32-97d3-c5a4f27f4ce9.jpeg)  
直到窗口中的字符串不再符合要求，left 不再继续移动：  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754619350-9bfe08f2-a742-42e2-a70f-2b45950ef29e.jpeg)  
...
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754619433-dd903d08-885b-4903-b3dc-7fc5d7a5ff8e.jpeg)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754619505-71be82e6-350c-433c-b359-ba26ca05fbdd.png)  
...
>
> ![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754619573-46504445-405e-4f97-bc42-c7c0be0f4c60.png)**输入:**  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754619632-56154932-e40f-41ad-b64d-c564fb971262.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754619704-1c17c4ff-06f4-4be2-8ad6-9c08bce6b82d.jpeg)  
...
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754619773-508159c8-9526-4a41-b950-d2a190d65ceb.jpeg)  
那么接下来，如何模拟在线段上扔石子？  
当然是随机数，比如上述前缀和数组 preSum，取值范围是 [1, 7]，那么我生成一个在这个区间的随机数 target = 5，就好像在这条线段中随机扔了一颗石子：  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754619841-b5860bae-742c-48fa-b0a0-a374a6083c60.jpeg)  
还有个问题，preSum 中并没有 5 这个元素，我们应该选择比 5 大的最小元素，也就是 6，即 preSum 数组的索引 3：  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754619918-ead45240-743e-4012-9065-4daf44c4d4d5.jpeg)**如何快速寻找数组中大于等于目标值的最小元素？**  [二分搜索算法](https://labuladong.github.io/algo/2/20/29/) **就是我们想要的**。  
到这里，这道题的核心思路就说完了，主要分几步：  
1、根据权重数组 `w` 生成前缀和数组 `preSum`。  
2、生成一个取值在 `preSum` 之内的随机数，用二分搜索算法寻找大于等于这个随机数的最小元素索引。  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754619988-e2412fe3-e88c-47fb-9cc0-2dc54edb556d.jpeg)  
下面来抠细节，继续前面的例子：  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754620065-c6e9a22e-f86a-4890-ab77-d7c5272cbc04.jpeg)  
就比如这个 preSum 数组，你觉得随机数 target 应该在什么范围取值？闭区间 [0, 7] 还是左闭右开 [0, 7)？  
都不是，应该在闭区间 [1, 7] 中选择，**因为前缀和数组中 0 本质上是个占位符**，仔细体会一下：  
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754620137-3415563b-8e2e-4477-bcd9-f99c8e920ede.jpeg)  
所以要这样写代码：
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754620212-206f5a9f-a1f8-415f-bc22-8ce70036c9b2.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754620274-a6b4d921-5ee8-4748-a37b-cafb8ddcda37.png)**原理很简单，回想 diff 数组反推 nums 数组的过程，diff[i] += 3 意味着给 nums[i..] 所有的元素都加了 3，然后 diff[j+1] -= 3 又意味着对于 nums[j+1..] 所有元素再减 3，那综合起来，是不是就是对 nums[i..j] 中的所有元素都加 3 了**？
...
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754620379-650876e7-9410-4739-ada3-25b6365e7544.jpeg)  
...
> 给定一个循环数组 `nums` （ `nums[nums.length - 1]` 的下一个元素是 `nums[0]` ），返回 __`nums`__ _中每个元素的_ _**下一个更大元素**_ 。
>
...
![](https://cdn.nlark.com/yuque/0/2025/jpeg/34814473/1736754620451-7f69276f-42e4-462c-8b6f-c843638c248d.jpeg)  
...
输出: [3,3,5,5,6,7]  
解释:  
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754620519-cb712540-a447-45ba-a4e4-29bc652a2fb4.png)
>
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754620576-368a8158-30ce-41e4-b13d-93e83485f838.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754620632-08aa6013-7e4c-4da8-b0a3-54af0b373e13.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754620700-3513c6ac-24df-4925-936b-5b855f32916c.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754620755-c2586be6-43ae-4471-9d33-5138c9fd9cc4.gif)  
但是当出队时，这个方法会造成信息丢失，**即当最大值出队后，我们无法知道队列里的下一个最大值。** ![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754621255-2db55873-9d0f-4db2-b614-82114e926356.gif)  
解题思路
...
![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754621686-9abcb59e-f14a-432e-bcce-dae43f6c145b.gif)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754622087-f44926af-f208-4173-9f5d-bb7ee963f50a.png)  
多叉树节点的代码实现是这样：
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754622154-7f5e6999-2fe6-4f75-969f-0d6f16710c6c.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754622220-96361a94-c4db-45bf-9780-8952e1fa6822.png)  
一个节点有 256 个子节点指针，但大多数时候都是空的，可以省略掉不画，**所以一般你看到的 Trie 树长这样**：  
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754622301-af9cab33-53aa-4f21-90a8-c73678958377.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754622369-ed87d578-0ac9-44e0-933d-409b85a8781d.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754622444-67eda6b5-2aaa-4da6-af42-7ab16853c90b.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754622525-402daeaf-1346-4942-96d9-ab3c4b12e02d.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754622600-3d816e9c-1834-4408-9be1-1d957f50efee.png)  
代码实现如下：
...
回顾一下我们 Trie 树的图：  
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754622672-f788a102-1821-40ce-8f1d-70e761e83684.png)  
...
![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754622745-a36a3d97-039e-4357-83ec-e3fdb60882d8.gif)  
...
![](https://cdn.nlark.com/yuque/0/2025/gif/34814473/1736754622796-5fec8e8b-2fe1-496b-a59b-cf503bf0bfa8.gif)  
最后，我们说一下 remove 函数，似乎所有数据结构的删除操作相对其他操作都会更复杂一些。

比如说下图这个场景，如果你想删除键 "team"，那么需要删掉 "eam" 这条树枝才是符合逻辑的：  
![](https://cdn.nlark.com/yuque/0/2025/png/34814473/1736754622880-bec44fc6-3cfd-42fb-b67e-0804a584de12.png)  
