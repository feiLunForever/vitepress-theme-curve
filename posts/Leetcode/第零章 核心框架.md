...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1676367058748-5d662e4f-dd14-4b46-a219-1d366aaf4a93-20240228160137-kprucq1.png" alt="image.png" style="zoom:50%;" />
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1676367602952-663ab3ff-43a5-49cf-a9bf-7a2a010812a9-20240228160139-5j7hzcf.png" alt="image.png" style="zoom:50%;" />
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1676367839724-c219d541-93a5-40eb-878b-cd7ff2104a38-20240228160140-gzbddm0.png" alt="image.png" style="zoom:50%;" />
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/image-20240826105959-sbjcxzp.png" alt="image" style="zoom:40%;" />​
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1679408205040-1e1357cc-d890-4e41-a315-30ba9806a2b3-20240228160142-4s9mkxz.png" alt="image.png" style="zoom:50%;" />
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1679408475282-a2ff7b58-859e-4920-a681-69d56b1f0241-20240228160142-10iwker.png" alt="image.png" style="zoom:80%;" />  

因此，可用动态规划解决此问题，以上公式便为转移方程。

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1679408487219-53346c3f-584f-48cd-bc42-51f654ebd57d-20240228160142-zoyvlyw.png" alt="image.png" style="zoom:50%;" />
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1679408615728-65a6a346-40a9-44a6-9352-92aa2c501a63-20240228160142-h5rd4xn.png" alt="image.png" style="zoom:70%;" />
...
**丑数递推公式：**  若索引 a,b,c 满足以上条件，则下个丑数 Xn+1 为以下三种情况中的 **最小值** ；
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1679483803769-690b5ff5-8de3-4fdb-9c7b-f2596ddd3956-20240228160143-1m2pce0.png" alt="image.png" style="zoom:80%;" />

由于 Xn+1 是 **最接近** Xn 的丑数，因此索引 a,b,c 需满足以下条件：

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1679483859325-f7be317e-96c8-4ce7-8aef-7b472e8f6f57-20240228160143-93q338o.png" alt="image.png" style="zoom:70%;" />

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1679483868906-0efad6fc-471a-47c2-bb98-52b73aa432e2-20240228160144-do6y01p.png" alt="image.png" style="zoom:60%;" />
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1679484074981-14af5f0c-e3df-4d84-9758-83bf8f4053c9-20240228160144-d8sp522.png" alt="image.png" style="zoom:80%;" />

- **初始状态：**  `dp[0]`​=1 ，即第一个丑数为 1 ；
- **返回值：**  `dp[n-1]`​ ，即返回第 *n* 个丑数；

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1679484277579-e30d9a90-ccea-4b6a-b12a-ce937654f383-20240228160144-4hy1oql.gif" alt="test.gif" style="zoom:90%;" />
...
题目需要我们求出所有点数出现的概率，根据概率的计算公式，点数 *k* 出现概率就算公式为：<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1680254288899-c7bf6e7d-8594-4f22-9159-d1dd61ebb555-20240228160144-2ebavu6.png" alt="image.png" style="zoom:60%;" />  
...
>
> <img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1676452052013-1adb9cca-d7de-4f3b-9b07-300a14d96e96-20240229204725-st95fq0.jpeg" alt="image" style="zoom:70%;" />​
>
> 输入：n = 4  
> 输出：[[".Q..","...Q","Q...","..Q."],["..Q.","Q...","...Q",".Q.."]]
>
...
- 如何表示两个方向的斜线呢？对于每个方向的斜线，需要找到斜线上的每个位置的行下标与列下标之间的关系。
    ...
    - 右对角线为从左上到右下方向，同一条斜线上的每个位置满足行下标与列下标之差相等，即 `row - j`​。
    - 例如 (0,0) 和 (3,3) 在同一条方向一的斜线上。因此使用行下标与列下标之差，即可明确表示每一条右对角线的斜线。

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1690795674696-45e11422-ea69-4476-871e-40fc7e6b0a7e-20240229204725-843vjyt.png" alt="image.png" style="zoom:40%;" />

- 左对角线为从右上到左下方向，同一条斜线上的每个位置满足行下标与列下标之和相等，即 `row + j`​。
- 例如 (3,0) 和 (1,2) 在同一条方向二的斜线上。因此使用行下标与列下标之和，即可明确表示每一条左对角线的斜线。

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1690795763175-93d20a7c-a902-49cd-8608-a4574d2787c1-20240229204725-dvg9h78.png" alt="image.png" style="zoom:40%;" />
...
> **示例 1：**
>
> <img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1676455001813-b3defe3e-59a5-446d-9a9f-5445e421e770-20240229204725-vbvnkzn.png" alt="image.png" style="zoom:80%;" />​
>
> 输入：n = 4  
> 输出：2  
> 解释：如上图所示，4 皇后问题存在两个不同的解法。
...
>
> <img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1678086966870-c8b7981b-e8bb-43c6-8837-30ce787b6542-20240229204725-5bxecqx.jpeg" alt="image" style="zoom:70%;" />​
>
> **示例 1：**
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1678087047673-c1ec3386-6d0f-4e57-8a23-c06b83ba2767-20240229204726-1pfqqtx.png" alt="image.png" style="zoom:50%;" />
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1678175295477-248c8f0f-3fdf-491d-9771-22b9db07368c-20240229204726-yivcaud.png" alt="image.png" style="zoom:35%;" />

将 i 加 1，j 不变，含义就是 p[j] 匹配了 s[i]，但 p[j] 还可以继续匹配，即通配符匹配多次的情况：

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1678175286848-6c9a4fc2-af31-448b-8fb6-65f6e2c58599-20240229204726-tn3eg4j.png" alt="image.png" style="zoom:35%;" />
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1678175287867-1900ccd4-97aa-42c6-ba89-656fc3662474-20240229204727-fdnvmcv.png" alt="image.png" style="zoom:35%;" />

2.1 通配符匹配 0 次

类似情况 1.1，将 j 加 2，i 不变：

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1678175302815-43f92159-d028-46ef-8a86-fb99a592bd1a-20240229204727-ypeb2g3.png" alt="image.png" style="zoom:35%;" />

2.2 如果没有 * 通配符，也无法匹配，那只能说明匹配失败了：

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1678175300394-db4ab92e-9d41-4fce-bcc4-ba6c36e4d30a-20240229204728-hpi3374.png" alt="image.png" style="zoom:35%;" />
...
>
> **示例 1：**   
> <img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1678714859621-1002e486-dc51-4036-afaa-ec806e4d12a8-20240229204728-24vxtiz.jpeg" alt="image" style="zoom:70%;" />  
>
        ...
        while (!q.isEmpty()) {
            ...
            for (int i = 0; i < sz; i++) {
                ...
                if (cur.equals(target))
                    return step;
                /* 将 cur 的相邻节点加入队列 */
                if (cur.left != null && !vusited.contains(cur.left)) {
                    q.offer(cur.left);
                    visited.add(cur.left);
                }
                if (cur.right != null && !vusited.contains(cur.right)) {
                    q.offer(cur.right);
...
func BFS(start *TreeNode, target *TreeNode) int {
  	q := []*TreeNode{start}
...
>
> **示例 1：**   
> ​<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1677315408601-e0936928-0bcb-45aa-9bef-9ca62c4aa3b1-20240307182750-xr52w96.jpeg" style="zoom:70%;" />  
>
> 输入：root = [3,9,20,null,null,15,7]  
> 输出：2
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1677316700301-08aadcc5-898b-4613-afd4-66626b5fe1d2-20240307182750-2kr84uf.png" alt="image.png" style="zoom:50%;" />
...
> **示例 1：**
>
> <img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/image-20240307190034-ry99443.png" alt="image" style="zoom:70%;" />
>
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1678706476014-bab82ed7-a922-48a3-86db-8fdce7125002-20240307182751-uv0epwu.gif" alt="test.gif" style="zoom:90%;" />
...
func searchRange(nums []int, target int) []int {
	...
	return []int{leftBounds(nums, target), rightBounds(nums, target)}
}

func leftBounds(nums []int, target int) int {
...
func rightBounds(nums []int, target int) int {
    left, right := 0, len(nums) - 1
    if nums[left] > target || nums[right] < target {
        return -1
    }
...
func calculate(weights []int, w int) int {
    cost, n := 0, len(weights)
    for i := 0; i < n; {
        cap := w
        for i < n && cap >= weights[i] {
            cap -= weights[i]
            i++
        }
        cost++
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059883392-b69cdbaa-c9fe-4253-a8aa-2d7498abfa1d-20240314140054-pql4yxv.gif" style="zoom:80%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059884806-3838d8b8-10f8-4cc6-bd9d-b3e96f2ee896-20240314140055-byr5f53.png" style="zoom:70%;" />  
...
初始状态：  
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059885185-d160beeb-9d2a-4601-b820-16bfbaf6f5a8-20240314140055-hpy6mk3.jpeg" style="zoom:50%;" />  
增加 right，直到窗口 [left, right) 包含了 T 中所有字符：  
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059886526-61664137-90bd-4e83-877c-4d0c6aac661f-20240314140055-6xg1n3r.jpeg" style="zoom:50%;" />  
现在开始增加 left，缩小窗口 [left, right)：  
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059886600-c653ac2c-7d58-41c8-8d16-55ba324c3ac3-20240314140055-2d7sl8v.jpeg" style="zoom:50%;" />  
直到窗口中的字符串不再符合要求，left 不再继续移动：  
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059887954-b5a86dfc-922c-4f2d-bf0c-6befcfd23fdc-20240314140055-8xvpr3w.jpeg" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059888004-cf8f61aa-ea2f-4a85-bcf3-482543e2b5f8-20240318155015-mce14gf.jpeg" style="zoom:50%;" />  
...
​<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059889490-7b4781a4-94d9-4a26-91b6-dd71a658ba5b-20240318155015-8cxuekx.png" style="zoom:50%;" />  
...
>
> <img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675083454015-cff9b1d6-6f17-4239-a5fb-1d12288064fc-20240318155015-tqz3p05.png" style="zoom:70%;" />
>
> **输入:**   
>
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059889862-ac87ed03-a12e-4c06-be6f-22a3373e3815-20240318155015-e29ytmj.png" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059900330-a63dade7-da4a-440c-80b0-4d419962ef94-20240318155015-blff1v7.jpeg" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059900566-14567d39-3c57-4ec0-9f26-a3bd3d86c128-20240318155015-c5zwiat.jpeg" style="zoom:50%;" />  

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059901475-7d12126a-9ca0-49f9-9b2c-8d29881c397d-20240318155015-oykim07.jpeg" style="zoom:50%;" />  

还有个问题，preSum 中并没有 5 这个元素，我们应该选择比 5 大的最小元素，也就是 6，即 preSum 数组的索引 3：  

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059901567-2ea0f376-9ffe-49e6-9dbf-2adb82808d49-20240318155015-dgyym4o.jpeg" style="zoom:50%;" />

**如何快速寻找数组中大于等于目标值的最小元素？**  **[二分搜索算法](https://labuladong.github.io/algo/2/20/29/)** 就是我们想要的。  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059902870-a0c72773-b524-495d-8c37-601bbe60ae0e-20240318155015-4au1sfd.jpeg" style="zoom:50%;" />  

下面来抠细节，继续前面的例子： 

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059903039-71de918e-94c9-4b88-87a0-91bfce83a6da-20240318155015-qhxar7o.jpeg" style="zoom:50%;" />  就

比如这个 preSum 数组，你觉得随机数 target 应该在什么范围取值？闭区间 [0, 7] 还是左闭右开 [0, 7)？  

都不是，应该在闭区间 [1, 7] 中选择，**因为前缀和数组中 0 本质上是个占位符**，仔细体会一下：  

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059903161-2bc3f16f-989c-4592-b4cb-5eac446299c7-20240318155016-jvybvxr.jpeg" style="zoom:50%;" />  
...
class Solution {
    public int[] constructArr(int[] a) {
        ...
        int[] postSuffix = new int[n]; // postSuffix[i] ->  i..n-1 后缀乘积
        preSuffix[0] = a[0];
        for (int i = 1; i < n; i++) {
...
func statisticalResult(arrayA []int) []int {
    ...
    preSuffix, postSuffix := make([]int, n), make([]int, n) 
    preSuffix[0] = arrayA[0]
    for i := 1; i < n; i++ {
        preSuffix[i] = preSuffix[i - 1] * arrayA[i]
    }
    postSuffix[n - 1] = arrayA[n - 1]
    for i := n - 2; i >= 0; i-- {
        postSuffix[i] = postSuffix[i + 1] * arrayA[i]
    }
    res := make([]int, n)
    res[0] = postSuffix[1]
    res[n - 1] = preSuffix[n - 2]
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059891329-445c7d64-7cc7-427f-9629-ae238dc611c0-20240319185932-yfdl078.png" alt="1675059891329-445c7d64-7cc7-427f-9629-ae238dc611c0" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059892860-95279b5a-e678-49e8-b874-c4ce11c248fb-20240319185932-26cgxuw.png" alt="1675059892860-95279b5a-e678-49e8-b874-c4ce11c248fb" style="zoom:50%;" />
...
public int[] corpFlightBookings(int[][] bookings, int n) {
        ...
        for(int[] booking : bookings) {
            ...
            int val = booking[2];
            diff[i] += val;
            if(j + 1 < n) { // [i...j] 都加了val，从 j+1 开始就不用加了
                diff[j + 1] -= val;
            }
        }
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059903229-fb23de19-5375-4bef-956d-aef044858551-20240320144925-ehkh5b5.jpeg" alt="1675059903229-fb23de19-5375-4bef-956d-aef044858551" style="zoom:50%;" />  
...
while 循环是把两个「个子高」元素之间的元素排除，因为他们的存在没有意义，前面挡着个「更高」的元素，所以他们不可能被作为后续进来的元素的下一个更大元素了。
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1675059903153-b9d419f2-909d-44dc-b4fb-f75e2d0f1028-20240320144925-qgkyhqu.jpeg" alt="1675059903153-b9d419f2-909d-44dc-b4fb-f75e2d0f1028" style="zoom:50%;" />  
...
> 解释: 
>
>  <img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1680252289130-e5a15abb-b4be-4319-8312-9d245617320e-20240321201605-t373xmf.png" alt="image.png" style="zoom:80%;" />​
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1681124787679-716f6e82-ca5b-4aba-b767-ce7321fd6590-20240321201606-zxk562f.png" alt="image.png" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1681124831976-40ffff92-6c82-4dab-a5ac-8ec069e01307-20240321201606-x20u7zd.png" alt="image.png" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1681124902655-00edd7ac-ca2e-4e3a-9d41-800d62263500-20240321201606-m7wz1v4.png" alt="image.png" style="zoom:50%;" />  
...
class Solution {
    public int[] maxAltitude(int[] heights, int limit) {
        if (heights == null || heights.length == 0 || limit == 0) return new int[0];
        int n = heights.length;
        int[] res = new int[n - limit + 1];
        LinkedList<Integer> window = new LinkedList<>(); // 单调队列 由 高 -》 低
        for (int i = 0; i < n; i++) {
            if (i < limit - 1) { // 先填充 前 limit - 1 个
                push(window, heights[i]);
            } else {
                push(window, heights[i]);
                res[i - limit + 1] = max(window);
                pop(window, heights[i - limit + 1]); // 移除 heights[i - limit + 1] 元素
            }
        }
        return res;
    }
    public void push (LinkedList<Integer> window, int num) {
        while (!window.isEmpty() && window.getLast() < num) { // 比当前值小的，都会被压扁
            window.removeLast();
        }
        window.addLast(num);
    }
    public int max (LinkedList<Integer> window) {
        return window.getFirst();
    }
    public void pop (LinkedList<Integer> window, int num) {
        if (window.getFirst() == num) { // 有可能 num 元素已经被压扁了，要判断下，如果头结点是num，才出队
            window.removeFirst();
        }
    }
}
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/image-20250619154705145.png" alt="image-20250619154705145" style="zoom:35%;" />  

但是当出队时，这个方法会造成信息丢失，**即当最大值出队后，我们无法知道队列里的下一个最大值。** <img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1681125426109-af782941-fb34-4ec9-9a44-3ddf1565f296-20240321201617-28cg58f.gif" alt="1.gif" style="zoom:35%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/image-20250619154759433.png" alt="image-20250619154759433" style="zoom:60%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686732385520-0ee122f8-071b-477b-a94b-c84c43d5d688-20240322101349-ahh04zs.png" alt="image.png" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686732426169-e5dc4e95-cfa8-468c-9ec1-fd0320a4a75d-20240322101350-4jda1jr.png" alt="image.png" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686732480981-9a906672-4c4d-44fe-b66b-06cec8f0610d-20240322101351-6n0r5jl.png" alt="image.png" style="zoom:50%;" />  

一个节点有 256 个子节点指针，但大多数时候都是空的，可以省略掉不画，**所以一般你看到的 Trie 树长这样**： 

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686732506084-47d85ea1-dde2-49da-bb5c-d38722453cfe-20240322101352-wbt98no.png" alt="image.png" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686732570855-e0482ca9-71de-4efd-a706-7f0256b6fa28-20240322101353-9cdf0j5.png" alt="image.png" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686732740846-d35aa699-3889-4eee-9dc1-469ae02e24be-20240322101354-9dxw9ax.png" alt="image.png" style="zoom:50%;" />
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686732888512-e7f7f0ab-76ec-491b-9b37-8b0927208ae6-20240322101355-n0mh224.png" alt="image.png" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686733282397-df766d55-ee07-4c77-8fe4-b94762e7b8be-20240322101355-99tq1lp.png" alt="image.png" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686733553684-7fc64607-aa69-4594-bd71-741082e159bf-20240322101356-tw1pid0.png" alt="image.png" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686733677902-e1eeb33c-7c94-44fe-bb63-01e3a952422b-20240322101356-e85pchp.gif" alt="a.gif" style="zoom:50%;" />  
...
<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686733830632-8aaf3e42-ab53-44b1-966f-4e4930f988e7-20240322101356-5b71bro.gif" alt="a.gif" style="zoom:50%;" />  

最后，我们说一下 remove 函数，似乎所有数据结构的删除操作相对其他操作都会更复杂一些。

比如说下图这个场景，如果你想删除键 "team"，那么需要删掉 "eam" 这条树枝才是符合逻辑的： 

<img src="https://gitee.com/JBL_lun/tuchuang/raw/master/assets/net-img-1686733849863-79a0e1f3-3686-46f6-9057-58849b73be8e-20240322101357-n5a3j10.png" alt="image.png" style="zoom:50%;" />  
