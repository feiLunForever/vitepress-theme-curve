...
​![image](/assets/image-20241113121133-5oahuhp.png)​
...
​![image](/assets/image-20241113121344-0hm9q93.png)​

1. 程序通过人类明确编写逻辑判断花种类（比如图片里有红色说明是玫瑰，图片里有橙色说明是向日葵）, 不涉及`机器学习`​，机器未参与学习过程。

### 机器学习

​![image](/assets/image-20241113122027-wf60cgc.png)​![image](/assets/image-20241113122136-r2kebnu.png)​
...
​![image](/assets/image-20241113121455-yqsx0lj.png)​

1. 在`监督学习`​里，`机器学习`​算法会接受有`标签`​的训练，**数据标签就是期望的输出值**，所以每个训练数据点都既包括输入特征，也包括期望的输出值。
2. 算法的目标是学习输入和输出之间的映射关系，从而在给定新的输入特征后，能够准确预测出相应的输出值。

​![image](/assets/image-20241113122912-h1u6hih.png)​

经典的`监督学习`​任务包括`分类`​和`回归`​

* 分类任务是将数据划分为不同类别，例如根据照片预测是猫还是狗；

  * ​![image](/assets/image-20241113122949-lxgdb7k.png)​
* 回归任务是预测数值，如预测房价。

  * ​![image](/assets/image-20241113123015-gt4v2sm.png)​
...
​![image](/assets/image-20241113123237-5kmnmt3.png)​

#### 强化学习

​![image](/assets/image-20241113123510-t5rochz.png)​![image](/assets/image-20241113123532-95069to.png)​
...
​![image](/assets/image-20241113121625-hk9rrwh.png)​
...
​![image](/assets/image-20241113132654-q9eebzu.png)​

### 大语言（LLM）模型

​![image](/assets/image-20241113133154-npcaos7.png)​
...
​![image](/assets/image-20241113154844-34gw323.png)​

###### 自注意力机制

​![image](/assets/image-20241113154330-8t6zb2x.png)​
...
​![image](/assets/image-20241113154709-ubr5ura.png)​
...
​![image](/assets/image-20241113154818-a93w77y.png)​
...
​![image](/assets/image-20241113155325-gl10pl8.png)​​![image](/assets/image-20241113155341-kn8774e.png)​
...
​![image](/assets/image-20241114134921-donbedb.png)​
...
​![image](/assets/image-20241224144910-95pf4bc.png)​
...
>
> ​![image](/assets/image-20241224144814-fslhlrj.png)​

###### ***编码器器部分***

1. 输入文本 `token`​ 化

​![image](/assets/image-20241114135447-xh1pge8.png)​
...
​![image](/assets/image-20241224145418-z0bz413.png)​​![image](/assets/image-20241224150548-d98h0c3.png)​
...
​![image](/assets/image-20241224145701-3ctycrb.png)​
...
​![image](/assets/image-20241224153708-jbpc0cj.png)​
...
​![image](/assets/image-20241224154111-ifjmhz4.png)​
...
​![image](/assets/image-20241224154745-oixv92s.png)​

4. 转换层

​![image](/assets/image-20241224155244-vo95kjg.png)​

​`解码器`​的最终阶段包括一个`线性层`​和一个`Softmax层`​，二者结合将`解码器`​输出的表示转化为词汇表的概率分布。这个词汇表的概率分布代表了下一个生成`token`​的概率，某些`token`​的出现概率会高于其他token。

​![image](/assets/image-20241224155305-cca4z1w.png)​
