...
​![image](/assets/image-20250106103211-qihi9h3.png)​
...
​![image](/assets/image-20250106103229-j81xqbx.png)​
...
​![image](/assets/image-20250106103243-uykzlae.png)​
...
​![image](/assets/image-20250106103300-ucf7jn7.png)​

**等值查询如果匹配不到值会在该区间加GAP锁**

图中向下黑箭头为GAP锁

​![image](/assets/image-20250106103317-culcmi7.png)​
...
​![image](/assets/image-20250106103331-9nf0ssq.png)​

**唯一索引等值查询间隙锁退化为记录锁**

(图中蓝色为记录锁)

​![image](/assets/image-20250106103341-0zp2jb5.png)​
...
​![image](/assets/image-20250106103352-ku20w9w.png)​
...
​![image](/assets/image-20250106103401-q7ep78g.png)​
...
​![image](/assets/image-20250106103422-ml355xy.png)​
...
​![image](/assets/image-20250106103430-4yg6k2a.png)​
...
​![image](/assets/image-20250106103439-j5inwqk.png)​
...
​![image](/assets/image-20250106103449-93y9q9t.png)​

T2 事务锁定读二级索引时，由于查询条件满足二级索引的值，因此不需要回表，但由于T1事务锁住二级索引上的记录，因此发生阻塞

​![image](/assets/image-20250106103456-7mj5n0w.png)​
...
​![image](/assets/image-20250106103508-vsibwgs.png)​

最终加锁状态：（name\_id中的+∞则指的是supremum）

​![image](/assets/image-20250106103514-4lpqfeq.png)​

其中只有id\=20的记录满足 `s_name > 'c' and s_age > 18`​，即使这些记录不满足条件也不会释放锁

因此T2要获取聚簇索引id\=1的记录时被阻塞，而T3则是被supremum阻塞

​![image](/assets/image-20250106103525-qk7fgp4.png)​
...
​![image](/assets/image-20250106103907-jvlgthq.png)​

加锁如下图

​![image](/assets/image-20250106103531-edpktd0.png)​
...
​![image](/assets/image-20250106103537-xgyf1bm.png)​
...
​![image](/assets/image-20250106103543-r5779cy.png)​
...
​![image](/assets/image-20250106103548-aw4v1c2.png)​
...
​![image](/assets/image-20250106103554-9yq1t1t.png)​

> 查看死锁日志

​![image](/assets/image-20250106103558-a93xt5n.png)​
...
* TRX_ID 最新事务 ID
* ROLL_PTR 回滚指针
* ​![image](/assets/image-20250106103620-9kvtt1v.png)​
...
​![image](/assets/image-20250106103711-pz8r8go.png)​
...
​![image](/assets/image-20250106103725-0g3jrj6.png)​
...
​![image](/assets/image-20250106103731-8hvp28f.png)​
...
​![image](/assets/image-20250106103740-oiz2k6y.png)​
...
​![image](/assets/image-20250106103929-zddcg9p.png)​
...
​![image](/assets/image-20250106103934-t2rn69i.png)​
...
​![image](/assets/image-20250106103939-287mlnk.png)​
...
​![image](/assets/image-20250106103943-3ziqkpw.png)​
...
​![image](/assets/image-20250106103948-96m4tmy.png)​
...
​![image](/assets/image-20250106103953-km216mu.png)​
...
​![image](/assets/image-20250106104001-l2i3sfu.png)​
...
​![image](/assets/image-20250106104006-r3ctv0z.png)​
...
​![image](/assets/image-20250106104012-gw49ia4.png)​

​![image](/assets/image-20250106104018-rxtghrm.png)​

​![image](/assets/image-20250106104022-p0y6sbj.png)​
...
​![image](/assets/image-20250106104026-4spjocx.png)​
